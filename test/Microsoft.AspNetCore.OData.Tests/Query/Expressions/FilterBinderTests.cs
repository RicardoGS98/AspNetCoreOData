...
public class FilterBinderTests
{
    ...
    [InlineData("cast(NullableIntProp,Edm.String) eq '123'", "$it => (IIF(Not($it.NullableIntProp.HasValue), null, $it.NullableIntProp.Value.ToString()) == \"123\")")]
    [InlineData("cast(NullableLongProp,Edm.String) eq '123'", "$it => (IIF(Not($it.NullableLongProp.HasValue), null, $it.NullableLongProp.Value.ToString()) == \"123\")")]
    [InlineData("cast(NullableSingleProp,Edm.String) eq '123'", "$it => (IIF(Not($it.NullableSingleProp.HasValue), null, $it.NullableSingleProp.Value.ToString()) == \"123\")")]
    [InlineData("cast(NullableDoubleProp,Edm.String) eq '123'", "$it => (IIF(Not($it.NullableDoubleProp.HasValue), null, $it.NullableDoubleProp.Value.ToString()) == \"123\")")]
    [InlineData("cast(NullableDecimalProp,Edm.String) eq '123'", "$it => (IIF(Not($it.NullableDecimalProp.HasValue), null, $it.NullableDecimalProp.Value.ToString()) == \"123\")")]
    [InlineData("cast(NullableBoolProp,Edm.String) eq '123'", "$it => (IIF(Not($it.NullableBoolProp.HasValue), null, $it.NullableBoolProp.Value.ToString()) == \"123\")")]
    [InlineData("cast(NullableByteProp,Edm.String) eq '123'", "$it => (IIF(Not($it.NullableByteProp.HasValue), null, $it.NullableByteProp.Value.ToString()) == \"123\")")]
    [InlineData("cast(NullableGuidProp,Edm.String) eq '123'", "$it => (IIF(Not($it.NullableGuidProp.HasValue), null, $it.NullableGuidProp.Value.ToString()) == \"123\")")]
    [InlineData("cast(NullableDateTimeOffsetProp,Edm.String) eq '123'", "$it => (IIF(Not($it.NullableDateTimeOffsetProp.HasValue), null, $it.NullableDateTimeOffsetProp.Value.ToString()) == \"123\")")]
    [InlineData("cast(NullableTimeSpanProp,Edm.String) eq '123'", "$it => (IIF(Not($it.NullableTimeSpanProp.HasValue), null, $it.NullableTimeSpanProp.Value.ToString()) == \"123\")")]
    [InlineData("cast(NullableSimpleEnumProp,Edm.String) eq '123'", "$it => (IIF(Not($it.NullableSimpleEnumProp.HasValue), null, Convert($it.NullableSimpleEnumProp.Value).ToString()) == \"123\")")]
    ...
    [InlineData("cast(Microsoft.AspNetCore.OData.Tests.Models.SimpleEnum'1',Edm.String) eq '1'", "$it => (Convert(Second).ToString() == \"1\")")]
